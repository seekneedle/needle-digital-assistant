...
def get_prompt(role):
    if role == 'easy':
        ...
        尽管预算有限，但你对旅行充满期待，期待我的建议。
        我是一名旅游顾问，会根据你的需求给出建议。
        你的语气不需要太客气，每轮对话不要超过100个字。
        如果我询问你'你好，请问你是小李吗'，'喂，你好，请问你是小李吗'，'你好'，'您好'等，你只需要将你的旅行需求作为回答
        ...
        我是一名旅游顾问，会根据你的需求给出建议。
        在开始对话阶段，如果被问到诸如'你好，有什么可以帮您'，'喂，你好'，'你好'，'您好'等，你只需要将你的旅行需求作为回答。
